...
2. Deep Scan for: node_modules, dist, build, out, .next, .nuxt, .turbo, .parcel-cache, __pycache__, target, .gradle, logs, *.log, .DS_Store
...
4. What it cleans: Grid 3x2 node_modules, dist/build/.next, .turbo, __pycache__, target, logs
